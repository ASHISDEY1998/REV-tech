      ...
      <main className="flex-grow">
        <section className="bg-secondary text-white py-20">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg mb-8">
              Earn coupons by using eco-friendly modes of transport like buses,
              metro, or walking to save the environment.
            </p>
            <a
              href="#download"
        ...
        <section id="download" className="bg-dark text-white py-20">
          <div className="container mx-auto text-center">
            ...
            <a
              href="#"
              className="bg-primary text-white px-6 py-3 rounded-full mx-2"
            >
              App Store
            </a>
            <a
